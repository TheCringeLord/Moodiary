...
class TColors {
  ...
  static Gradient darkLinearGradient = LinearGradient(
    ...
    colors: [
      const Color.fromARGB(255, 149, 255, 205).withAlpha(255),
      const Color.fromARGB(255, 34, 223, 236).withAlpha(150),
      const Color.fromARGB(255, 160, 212, 255).withAlpha(80),
      const Color.fromARGB(255, 238, 255, 160).withAlpha(30),
      const Color.fromARGB(255, 255, 238, 160).withAlpha(0)
    ],
  );
  static Gradient lightLinearGradient = LinearGradient(
    ...
    colors: [
      const Color.fromARGB(255, 103, 167, 250).withAlpha(150),
      const Color.fromARGB(255, 123, 213, 255).withAlpha(80),
      const Color.fromARGB(255, 149, 221, 255).withAlpha(50),
      const Color.fromARGB(255, 160, 255, 231).withAlpha(10),
      const Color.fromARGB(255, 160, 255, 219).withAlpha(0)
    ],
  );
